...
1. ✅ Issue number is provided and valid (e.g., `11` or `#11`)
2. ✅ Code branch exists or files are provided
3. ✅ Rules files exist in `specs/rules/` folder
4. ✅ Issue file exists in `specs/issues/` folder
